...
### Phase 9: 更多游戏内容扩展
- [ ] 基于时间的光照系统（当前光照过亮，略有泛白）
- [ ] 太阳、月亮、云等天空系统
- [ ] 实体系统．如沙子坠落等

### Phase 10: 渲染优化与性能提升
#### 10.1 自定义雾Shader系统（原版Minecraft风格雾效）✅ 已完成
...
- [ ] **加载队列优化**:
  ...
  - 视线方向（玩家面向）区块优先
  - 分帧处理，避免单帧生成过多区块
- [ ] **Fallback机制**: Worker加载失败时回退到主线程生成

#### 10.3 附加优化（可选）
- [ ] **LOD系统**: 远距离区块简化渲染
  - Level 0 (0-2 chunks): 完整细节 16×256×16
  - Level 1 (3-4 chunks): 简化高度 16×128×16
  - Level 2 (5-8 chunks): 合并方块 8×64×8
- [ ] **Greedy Meshing**: 进一步优化远距离区块面数
